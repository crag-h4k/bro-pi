...
#from rgb.rgb.py import rgb_on, blink_led, morph_colors
#rgb_on(color)
#blink_led(color)
#morph_color(brighness, interval)
# ratios of .255
#2/3 = .17
#1/2 = .1275
#1/3 = .085
...
red_led_pin = ['13', 'red_pin']
green_led_pin = ['19', 'green_pin']
blue_led_pin = ['26', 'blue_pin']
